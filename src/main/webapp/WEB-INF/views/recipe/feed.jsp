...
.lecture .lec-list { display: block; margin-top: 20px; }
.lecture .lec-list .insertClass {  width: 200px; height: 50px; line-height: 48px; font-size: 20px; font-weight: 700; text-align: center; color: #fff; background: #77b347; margin: 0 22px 35px auto; }
							...
							<div>
								<div class="img-area">
									<a href="${articleUrl}recipeNum=${dto.recipeNum}">
										<img src="${pageContext.request.contextPath}/uploads/recipe/${dto.imageFilename}">
									</a>						
								</div>
								<div class="text-area">
									<p>${dto.recipeSubject}</p>
